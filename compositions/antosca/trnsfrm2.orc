...
instr 1                                                                         ; the transform
  ...
  a6        oscil     iscale * k1, inote * .85 + k2, itranswv2 ; oscillators with vibrato added
  a5        oscil     iscale * k1, inote * 1.25 + k2, itranswv2
  a4        oscil     iscale * k1, inote + k2, itranswv2
  a3        oscil     iscale * k1, inote * .700 + k2, itranswv1
  a2        oscil     iscale * k1, inote * 1.5 + k2, itranswv1
