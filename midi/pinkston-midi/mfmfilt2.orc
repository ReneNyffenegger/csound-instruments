...
instr          1
  ...
  indxbase  =  (1 <= 2 ? 1 : 2)
  indxmax   =  (1 <= 2 ? 2 : 1)
  kmodchg   oscil1i   0.00,(imodmax - imodbase),5,4
  ...
  afm       =  afmttl - aoscttl
  icfbase   =  (40 <= 120 ? 40 : 120)
  icfmax    =  (40 <= 120 ? 120 : 40)
  kcfchg    oscil1i   0.00,(icfmax - icfbase),5,7
  kcf       =  icfbase + kcfchg
  ibwbase   =  (100 <= 400 ? 100 : 400)
  ibwmax    =  (100 <= 400 ? 400 : 100)
  kbwchg    oscil1i   0.00,(ibwmax - ibwbase),5,5
  kbw       =  ibwbase + kbwchg
