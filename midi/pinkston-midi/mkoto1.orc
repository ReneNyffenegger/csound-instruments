...
instr               1
  ...
  kbend     oscil1i   0.15,0,13.21,4
  khz       =  cpsoct(koct+kbend)
  khz2      =  cpsoct(koct2+kbend)
  khz3      =  cpsoct(koct3+kbend)
  khz4      =  cpsoct(koct4+kbend)
  khz5      =  cpsoct(koct5+kbend)
  aplk1     pluck     (10000*.62),khz,ihz,0,3,0
            timout    0.0,.002,continue
koto2:
  aplk2     pluck     (10000*.62),khz2,ihz2,0,3,0
            timout    0.0,.004,continue
koto3:
  aplk3     pluck     (10000*.62),khz3,ihz3,0,3,0
            timout    0.0,.005,continue
koto4:
  aplk4     pluck     (10000*.62),khz4,ihz4,0,3,0
            timout    0.0,.007,continue
koto5:
  aplk5     pluck     (10000*.62),khz5,ihz5,0,3,0
continue:
  asignal   =  aplk1+aplk2+aplk3+aplk4+aplk5
  asig      envlpx    asignal,.0001,13.21,(13.21*.1),2,.999,.008
            out       asig*kgate
endin
