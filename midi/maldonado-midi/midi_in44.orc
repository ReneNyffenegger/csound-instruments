; "FOUR IN ONE" EXAMPLE OF USING IMIDIC7 AS A SWITCH FOR SEVERAL INSTRUMENTS
...
;/////////////////////////////////////////////////////////////////////
  ijump     midic7    1,0,4                       ;SWITCH FOUR INSTRUMENTS AT INIT TIME (RANGE 0-4)
                         ...
                         ;    4=instr4
;//////////////////////////////////////////////////////////////////////
  kctr1     midic7    2,0,1                       ;SCALES DIFFERENT INSTRUMENTS PARAMETERS (RANGE 0-1)
  kctr2     midic7    4,0,1                       ;SCALES DIFFERENT INSTRUMENTS PARAMETERS (RANGE 0-1)
;
