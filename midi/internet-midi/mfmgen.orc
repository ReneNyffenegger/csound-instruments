...
a:  if      in5=1   goto a1                     ;A1, A2 PRODUCE DIFFERENT TIMBRES WITH
...
a1: if      in6=1   goto a1a                    ;HZU, HZL SBS OF FUND OF MODULATOR
...
a1b:iu      =       in9*(in14/in13)             ;P13=FUNDAMENTAL OF MODULATOR
    il      =       (in10*(-in9))*(in14/in13)   ;P14=SECOND PARTIAL OF MODULATOR
    goto    x
a1c:iu      =       in9
    il      =       (in10*(-in9))*(in14/in13)   
    goto    x
a1d:iu      =       in9*(in14/in13)
    il      =       in10*(-in9) 
    goto    x

a2: if      in6=1   goto a2a
    if      in6=2   goto a2b
    if      in6=3   goto a2c
    if      in6=4   goto a2d    
...
a2a:il      =       -in9              
    iu      =       in10*in9
    goto    x
a2b:il      =       -in9*(in14/in13)
    iu      =       (in10*in9)*(in14/in13)
    goto    x
a2c:il      =       -in9*(in14/in13)
    iu      =       in10*in9
    goto    x
a2d:il      =       -in9
    iu      =       (in10*in9)*(in14/in13)     
...
b1a:iu      =       in9
    il      =       in10*(-in9)
    goto    y
b1b:iu      =       in9*(in14/in13)
    il      =       (in10*(-in9))*(in14/in13)
    goto    y 
b1c:iu      =       in9
    il      =       (in10*(-in9))*(in14/in13)
    goto    y
b1d:iu      =       in9*(in14/in13)
    il      =       in10*(-in9) 
    goto    y

b2: if      in6=1   goto b2a
    if      in6=2   goto b2b
    if      in6=3   goto b2c
    if      in6=4   goto b2d    
b2a:il      =       -in9              
    iu      =       in10*in9
    goto    y
b2b:il      =       -in9*(in14/in13)
    iu      =       (in10*in9)*(in14/in13)
    goto    y
b2c:il      =       -in9*(in14/in13)
    iu      =       in10*in9
    goto    y
b2d:il      =       -in9
    iu      =       (in10*in9)*(in14/in13)     
...
y:  imod    =       (ihzu-(-ihzl))/(iu-il)
    icar    =       ihzu-(iu*imod)     
    goto    z

z:  a1      oscili  imod*in11,imod,2                    ;p11=index
