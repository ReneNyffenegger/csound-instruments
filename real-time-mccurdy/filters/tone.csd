...
ih		 	FLbox  	"Tone is an implementation of a second-order low-pass filter  ", 	1,      5,     14,    490,    15,     5,  40
...
CONTINUE:
aresL 		tone 	gasigL, gkhp, i(gkskip)
aresR 		tone 	gasigR, gkhp, i(gkskip)
