...
koto2:
  aplk2     pluck     (p4*.62),khz2,ihz2,6,4,1, 1.005
            timout    0.0,.004,continue
koto3:
  aplk3     pluck     (p4*.62),khz3,ihz3,6,4,1, 1.003
            timout    0.0,.005,continue
koto4:
  aplk4     pluck     (p4*.62),khz4,ihz4,6,4,1, 1.002
            timout    0.0,.007,continue
koto5:
  aplk5     pluck     (p4*.62),khz5,ihz5,6,4,1, 1.001
continue:
