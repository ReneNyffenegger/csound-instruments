;====================================================================;
;       Test score for DX7 alg 03 orc                                ;
;                                                                    ;
;       (imitates the Metamonics voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    1   99   30   40   63   
        99   90   0   0   
        1   0   2.000000   0   
        1   
f13   0    32    -2    70    0   99   99   99   99   
        99   99   99  99   
        0   1   1.02300000   0   
        0   
f14   0    32    -2    50    0   99   99   99   99   
        99   99  99  99   
        0   1   10.000   0   
        0   
f15   0    32    -2    90    1   90   30   40   50   
        99   90   0   0   
        1   1   1.000000   0   
        1   
f16   0    32    -2    70    0   99   94   63   26   
        99   94   84   0   
        0   0   2.0000   1 
        0   
f17   0    32    -2    80    0   95  99   99   42   
        99   99   50   30  
        0   0   0.50001   -1   
        0   
...
t 0 20
i01 0 .49 8.00 87 0 60 11 31 
 12 13 14 15 16 17 2 12000
 3 8 4 6 10 9 11 1
; Algorithm = 3
; Patch name is Metamonics (SY77)

i 1.1   1.00   .54  6.07    47
i 1.2   2.00   .16  6.08    45
i 1.3   2.49   .20  7.03    40
i 1.4   3.01   .20  7.04    44
i 1.5   3.50   .18  7.11    50
i 1     4.01   .15  8.00    45
i 1.1   4.24   .13  8.07    59
i 1.2   4.50   .07  8.08    32
i 1.3   4.72   .09  9.03    20
i 1.4   4.98   .16  9.00    69
