;====================================================================;
;       test score for DX7 alg 19 orc                                ;
;                                                                    ;
;       (imitates the PIPES 1A   voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   55   25   25   36   
        99   99   98   0   
        0   0   0.500000   7   
        5   
f13   0    32    -2    90    0   99   97   62   47   
        99   99   90   0   
        0   0   0.500000   -7   
        4   
f14   0    32    -2    75    0   99   97   62   47   
        99   99   90   0   
        0   0   1.000000   -4   
        5   
f15   0    32    -2    78    0   61   25   25   50   
        99   99   97   0   
        0   0   4.000000   5   
        3   
f16   0    32    -2    87    0   61   25   25   61   
        99   99   93   0   
        0   0   2.000000   -5   
        3   
f17   0    32    -2    76    2   72   25   25   70   
        99   99   99   0   
        0   0   10.000000   0   
        3   
t 0 40
i01 0 .49 6.00 87 0 33 0 34 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 0
; Algorithm = 19
; Patch name is PIPES 1A  
