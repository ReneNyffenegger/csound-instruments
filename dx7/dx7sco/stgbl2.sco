...
;                                                                    ;
;       (imitates the STGBL voice...sort of)                      ;
;                                                                    ;
;       RFP 11:40 7-19-89                                            ;
;====================================================================;
f01     0       512     10      1
...
f11     0       8       -7      0       8       7            
f12   0    32    -2    99    0   70   42   17   34   
        99   99   74   0   
        3   0   1.0   0   
        3   
f13   0    32    -2    71    0   99   0   0   0   
        99   99   99   0   
        0   0   3.0   7   
        7   
f14   0    32    -2    99    0   99   99   36   35   
        99   99   0   0   
        3   0   2.0   0   
        3   
f15   0    32    -2    99    0   99   72   31   17   
        0   70   0   0   
        0   0   14.56   0   
        7   
f16   0    32    -2    99    0   70   42   16   34   
        99   99   80   0   
        3   0   1.0   7   
        4   
f17   0    32    -2    60    0   99   0   0   0   
        99   99   99   0   
        0   0   1.0   -7   
        7   
i01 0 .49 6.00 87 0 40 43 34 
 12 13 14 15 16 17 2 8000
 3 8 4 6 10 9 11 7
; Patch name is STGBL 14.6
