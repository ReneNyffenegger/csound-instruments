;====================================================================;
;       Test score for DX7 alg 18 orc                                ;
;                                                                    ;
;       (imitates the W.BASS   3 voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   78   7   20   31   
        99   0   0   0   
        0   0   0.500000   -1   
        7   
f13   0    32    -2    77    2   72   28   28   51   
        99   89   0   0   
        0   0   2.020000   2   
        3   
f14   0    32    -2    65    1   70   20   28   68   
        99   89   0   0   
        0   0   1.020000   -2   
        4   
f15   0    32    -2    98    2   93   66   31   55   
        96   76   0   0   
        0   0   0.510000   2   
        3   
f16   0    32    -2    61    2   99   25   41   99   
        99   99   96   0   
        0   0   0.995000   2   
        3   
f17   0    32    -2    78    5   94   26   29   55   
        96   78   50   0   
        0   0   4.500000   3   
        2   
t 0 20
