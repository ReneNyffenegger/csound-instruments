;====================================================================;
;       Test score for DX7 alg 15 orc                                ;
;                                                                    ;
;       (imitates the UIL.PIPES  voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    1   65   50   50   50   
        80   99   80   0   
        0   0   1.000000   0   
        0   
f13   0    32    -2    71    0   99   50   50   50   
        80   99   90   0   
        0   0   1.000000   0   
        3   
f14   0    32    -2    99    1   64   50   50   50   
        80   99   90   0   
        0   0   1.000000   0   
        0   
f15   0    32    -2    74    0   64   50   50   50   
        80   99   90   0   
        0   0   1.000000   0   
        1   
f16   0    32    -2    72    0   99   50   50   50   
        80   99   90   0   
        0   0   2.000000   0   
        0   
f17   0    32    -2    99    1   99   50   50   50   
        80   99   90   0   
        0   0   3.000000   0   
        5   
t 0 20
i01 0 2.49 6.00 87 0 0 0 50 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Algorithm = 15
; Patch name is UIL.PIPES 
