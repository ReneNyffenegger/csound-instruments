;====================================================================;
;       test score for DX7 alg 1 orc                                ;
;                                                                    ;
;       (imitates the STRINGS JH voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    92    0   48   56   10   47   
        98   98   36   0   
        0   0   2.000000   0   
        0   
f13   0    32    -2    74    0   81   13   7   25   
        99   92   28   0   
        0   0   2.000000   -6   
        0   
f14   0    32    -2    92    0   51   15   10   47   
        99   92   0   0   
        0   0   2.000000   6   
        0   
f15   0    32    -2    76    0   49   74   10   32   
        98   98   36   0   
        0   0   2.000000   0   
        0   
f16   0    32    -2    66    0   76   73   10   28   
        99   92   0   0   
        0   0   2.000000   0   
        0   
f17   0    32    -2    92    0   99   62   34   32   
        99   92   0   0   
        0   0   1.000000   0   
        0   
t 0 20
i01 0 2.49 6.00 87 0 81 8 30 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Algorithm = 1
; Patch name is STRINGS JH
