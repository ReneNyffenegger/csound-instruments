;====================================================================;
;       test score for DX7 alg 01 orc                                ;
;                                                                    ;
;       (imitates the STG.M.15.5 TFI5 voice...sort of)                      ;
;                                                                    ;
;       RFP 11:40 7-19-89                                            ;
;====================================================================;
f01     0       512     10      1
...
f11     0       8       -7      0       8       7            
f12   0    32    -2    99    1   46   33   20   46   
        99   92   84   0   
        3   1   1   2   
        2   
f13   0    32    -2    84    1   99   46   0   44   
        99   93   87   0   
        0   0   2.5   6   
        1   
f14   0    32    -2    99    0   46   33   20   43   
        99   92   84   0   
        3   1   1   3   
        2   
f15   0    32    -2    84    1   99   46   0   46   
        99   93   87   0   
        0   0   2.5   2   
        1   
f16   0    32    -2    77    0   99   46   0   43   
        99   93   87   0   
        0   0   2.5   -2   
        1   
f17   0    32    -2    71    0   99   46   0   43   
        99   93   87   0   
        0   0   5.0   0   
        1   
i01 0 .49 6.00 87 0 33 17 38 
 12 13 14 15 16 17 2 16000
 3 8 4 6 10 9 11 7
; Patch name is STG.M.15.5
t 40
