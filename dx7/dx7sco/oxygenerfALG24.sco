;====================================================================;
;       Test score for DX7 alg 24 orc                                ;
;                                                                    ;
;       (imitates the OXYGENE RF voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   40   44   32   35   
        99   99   99   0   
        0   0   1.000000   7   
        7   
f13   0    32    -2    99    0   40   44   32   35   
        99   99   99   0   
        0   0   1.000000   -1   
        7   
f14   0    32    -2    99    0   50   44   20   37   
        99   0   0   0   
        0   1   2.884000   0   
        3   
f15   0    32    -2    99    0   50   44   20   37   
        99   0   0   0   
        0   1   2.884000   0   
        3   
f16   0    32    -2    99    0   50   44   32   35   
        99   99   99   0   
        0   1   1.000000   0   
        3   
f17   0    32    -2    84    0   99   44   32   35   
        99   99   99   0   
        0   0   1.000000   0   
        0   
t 0 20
i01 0 2.49 6.00 87 0 0 0 21 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 3
; Algorithm = 24
; Patch name is OXYGENE RF
