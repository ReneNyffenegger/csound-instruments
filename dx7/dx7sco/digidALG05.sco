;====================================================================;
;       Test score for DX7 alg 05 orc                                ;
;                                                                    ;
;       (imitates the DIGI D     voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   22   27   30   36   
        99   50   35   0   
        0   0   1.000000   -5   
        0   
f13   0    32    -2    99    0   25   28   30   38   
        99   55   38   0   
        0   0   3.000000   0   
        0   
f14   0    32    -2    99    0   30   28   45   36   
        99   48   40   0   
        0   0   1.000000   2   
        0   
f15   0    32    -2    99    0   33   26   44   35   
        99   51   46   0   
        0   0   7.000000   -2   
        0   
f16   0    32    -2    99    0   28   29   34   35   
        99   31   30   0   
        0   0   1.000000   1   
        0   
f17   0    32    -2    89    0   28   29   28   35   
        99   46   34   0   
        0   0   3.500000   4   
        0   
...
t 0 20
i01 0 2.49 6.00 87 0 0 0 45 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 1
; Algorithm = 5
; Patch name is DIGI D    
