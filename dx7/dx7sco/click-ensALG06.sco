;====================================================================;
;       test score for DX7 alg 6 orc                                ;
;                                                                    ;
;       (imitates the CLICK-ENS  voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   85   31   10   35   
        96   99   85   0   
        0   0   2.020000   -7   
        1   
f13   0    32    -2    60    0   99   13   50   32   
        90   90   90   0   
        0   0   5.000000   0   
        1   
f14   0    32    -2    99    0   40   30   10   35   
        96   99   83   0   
        0   0   2.020000   0   
        1   
f15   0    32    -2    93    0   49   99   15   32   
        66   90   85   0   
        0   0   0.500000   0   
        0   
f16   0    32    -2    99    0   45   31   10   35   
        96   99   85   0   
        0   0   2.000000   0   
        1   
f17   0    32    -2    64    0   45   31   10   35   
        96   99   85   0   
        0   0   1.000000   0   
        1   
t 0 20
i01 0 2.49 6.00 87 0 49 9 25 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 6
; Algorithm = 6
; Patch name is CLICK-ENS 
