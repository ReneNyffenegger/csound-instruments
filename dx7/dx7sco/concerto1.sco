...
;                                                                    ;
;       (imitates the CONCERTO 1 voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    80    0   17   15   10   20   
        99   92   0   0   
        0   0   2.000000   -1   
        7   
f13   0    32    -2    99    0   99   15   10   20   
        99   92   0   0   
        0   0   1.000000   7   
        7   
f14   0    32    -2    99    0   99   15   10   20   
        99   92   0   0   
        3   0   1.000000   7   
        7   
f15   0    32    -2    71    0   99   15   10   20   
        99   92   0   0   
        0   0   1.000000   0   
        7   
f16   0    32    -2    66    0   99   15   10   20   
        99   92   0   0   
        0   0   2.000000   0   
        7   
f17   0    32    -2    62    0   99   15   10   20   
        99   92   0   0   
        0   0   4.000000   0   
        7   
...
t 0 20
i01 0 11.49 6.00 87 0 72 0 15 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 3
; Algorithm = 2
; Patch name is CONCERTO 1

f0         2                             ;allow for a 4-beat final decay.
e
