...
;                                                                    ;
;       (imitates the VIOLN 21.3 TFI3.DX7 voice...
;                                                                    ;
;       RFP 11:40 7-19-89                                            ;
;====================================================================;
f01     0       512     10      1
...
f11     0       8       -7      0       8       7            
f12   0    32    -2    99    2   41   25   22   45   
        99   97   86   0   
        3   1   1.10   -1   
        4   
f13   0    32    -2    76    0   99   0   0   30   
        99   98   97   0   
        0   0   3.0   -7   
        1   
f14   0    32    -2    99    7   53   18   17   56   
        99   95   92   0   
        3   0   3.0   -1   
        2   
f15   0    32    -2    87    0   61   30   0   35   
        99   98   90   0   
        0   0   3.0   0   
        3   
f16   0    32    -2    77    2   99   49   55   46   
        99   90   80   0   
        0   0   9.0   3   
        2   
f17   0    32    -2    44    0   99   42   50   59   
        99   99   99   0   
        0   1   8.31   5   
        0   
i01 0 .49 6.00 87 0 0 11 35 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Patch name is VIOLN 21.3
