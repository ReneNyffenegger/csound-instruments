...
;      1   3   5        1   3   5ы      1   ю 3 ы        1   ю 3 ы   ;
;                                                                    ;
;                                                                    ;
;  9)               10)             11)              12)             ;
;                                                                    ;
;              6                3]              3        4  5  6  2] ;
;     [2   4   5        5   6   2       5   6]  2        юд 3 ды  1  ;
;                                                                    ;
;                                                                    ;
;  13)              14)             15)              16)             ;
;                           5   6]          5   6            4   6]  ;
;      4  5  6] 2       2   ю 4 ы      [2   ю 4 ы        2   3   5   ;
;      юд 3 ды  1       1     3         1     3          юдд 1 дды   ;
;                                                                    ;
;                                                                    ;
;  17)              18)         6   19)             20)              ;
;          4   6                5       3                            ;
;     [2   3   5        2   3]  4       2   з 6]©        з[3 © 5   6 ;
;      юдд 1 дды        юдд 1 дды       1   4   5        1   2 ю 4 ы ;
;                                                                    ;
;                                                                    ;
;  21)              22)             23)             24)              ;
;                                                                    ;
;     з 3]©  з 6 ©      2  зд 6]д©         3  з 6]©          зд 6]д© ;
...
;                                                            5]      ;
;              зд6]©       3  5   6]       3] 5   6      2   4       ;
;     1  2  3  4   5    1  2  ю 4 ы     1  2  ю 4 ы      1   3   6   ;
;                                                                    ;
;                                                                    ;
;  29)              30)             31)             32)              ;
;                             5]                                     ;
...
output:
 	...
 	k6gate	tablei	k6phs,idevfn
        ...
        a1phs   phasor  i1hz
        a1sig   tablei  a1phs+a6sig,1,1,0,1
        a1sig   =       a1sig*k1gate
                out     (.2*(a1sig+a2sig+a3sig+a4sig+a5sig)) * ipkamp
                endin
