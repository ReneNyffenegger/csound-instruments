...
;                   -AMP,         FREQ,PRES,RAT,    VFRQ,    VGN, TAB, LFREQ
  a1        wgbow     p4, cpspch(p5), p6, p7, 6.12723, kv*0.01, 1, 50
            out       a1
endin         
...
instr     8
;                   AMP,     FREQ, BEANS, DAMP, TIMES, DETTACK
  a1        shaker    p4, cpspch(p5),        p6,   p7,   100, 0
            out       a1
endin         
...
instr     17
  k1        line      0, p3, 64
; a1      voice     31129.60, 440, 0, 0, 0, 0, 7, 1
  a1        voice     10000, 440, 0, 0, 0, 0, 7, 1
            out       a1
endin
