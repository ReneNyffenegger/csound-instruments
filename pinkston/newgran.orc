...
a1      granule	kenv,ivoice,iratio,imode,ithd,ifn,ipshift,igskip,igskoff,iflen,kgap, \
		   igapoff,ksize,isizoff,iatt,idec,iseed,ipitch1,ipitch2,ipitch3,ipitch4
a2      granule	kenv,ivoice,iratio,imode,ithd,ifn,ipshift,igskip,igskoff,iflen,kgap, \
		   igapoff,ksize,isizoff,iatt,idec,iseed+.017,ipitch1,ipitch2,ipitch3,ipitch4
        outs a1,a2
	endin
