...
itmp	ftgen 3, 0, 4096, -10,	1.0, 1.0, 0.25, 1.0, 0.125, 0.5, 0, 0.25,    \
				0, 0.125, 0, 0.1667, 0, 0.0625, 0, 0.125
; LFO waveform for triangle distribution
itmp	ftgen 4, 0, 256, 7,  0, 16, 0.134, 16, 0.293, 16, 0.5, 16, 1,	     \
				16, 0.5, 16, 0.293, 16, 0.134, 16, 0,	     \
				16, -0.134, 16, -0.293, 16, -0.5, 16, -1,    \
				16, -0.5, 16, -0.293, 16, -0.134, 16, 0
; sawtooth wave
...
a1	oscbnk	kcps, 0.0, kcps * 0.02, 0.0, 8, 0,			\
		kl1minf, kl1maxf, 0.0, 0.0, 128,			\
...
a2	grain3 kcps, 0.5, kcps * 0.02, 0.5, kwsiz, kdens, iovrlp + 1,	\
		kfnum, 2, -0.5, 0, 0, 18
...
kdens	=  iovrlp / kwsiz	; density
a3	grain3 kcps2, 0.5, kcps2 * 0.02, 0.5, kwsiz, kdens, iovrlp + 1,	\
		kfnum2, 2, -0.5, 0, 0, 18
