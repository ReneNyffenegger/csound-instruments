...
#define ROOM_TABLE	# 225 #		/* room parameters are stored in     */
					/* this table			     */
i_	ftgen $ROOM_TABLE, 0, 64, -2,	0, -1, -1, -1, -1, 0,		      \
					0, 1.0, 0, 0, 1000.0, 1.0, 0.7, 0,    \
					0, 1.0, 0, 0, 1000.0, 1.0, 0.7, 0,    \
					0, 1.0, 0, 0, 1000.0, 1.0, 0.7, 0,    \
					0, 1.0, 0, 0, 1000.0, 1.0, 0.7, 0,    \
					0, 1.0, 0, 0, 1000.0, 1.0, 0.7, 0,    \
...
i_	ftgen $HRTFtable, 0, 32, -2,	256, 64, 576, 64, 10, 1050, 50, 0,    \
					56, 56, 56, 56, 56,		      \
					56, 60, 72, 72, 72, 72, 72, 60, 56,   \
					45, 36, 24, 12, 1
...
a_1_, a_2_, a_3_, a_4_	spat3di a_ + (1.0 / 1.0e24), i_1_, i_2_, i_3_,	\
				$SPAT_H__idist_, $ROOM_TABLE, $SPAT_H__imode_
...
a_1_, a_2_, a_3_, a_4_	spat3d a_ + (1.0 / 1.0e24), k_1_, k_2_, k_3_,	\
				$SPAT_H__idist_, $ROOM_TABLE,		\
				$SPAT_H__imode_, 2.0, $SPAT_H__iover_
